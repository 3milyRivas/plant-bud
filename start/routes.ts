...
router
  .group(() => {
    ...
    router.on('/unauthorized').render('pages/errors/unauthorized').as('unauthorized')
    ...
    router.get('/plants/search', '#controllers/plants_search_controller.search')
    ...
    router.on('/request').render('pages/request').as('request')
    ...
    router.get('/community/media/:userId/:fileName', [CommunityController, 'media']).as('community.media')
    router.get('/favorites', [CommunityController, 'favorites']).as('community.favorites')
    router.get('/notification', [CommunityController, 'notifications']).as('community.notifications')
    router.get('/users/:username', [CommunityController, 'showUser']).as('community.users.show')
    router.post('/users/:username/follow', [CommunityController, 'toggleFollow']).as('community.users.follow')
    router
