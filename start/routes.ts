...
router.on('/care3').render('pages/client/Plants/ware')
router.on('/care1').render('pages/client/Plants/care-ornamentals')
router.on('/care2').render('pages/client/Plants/care-orticultural')
